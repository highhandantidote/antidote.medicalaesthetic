"""
Process just 2 threads at a time to ensure script completes.
This micro-batch script avoids timeouts by processing only 2 threads.
"""
import os
import logging
import psycopg2
...
# Constants
BATCH_SIZE = 2  # Micro batch to ensure completion
MIN_REPLIES = 2
MAX_REPLIES = 3
...
def get_threads_without_replies():
    """Get just 2 threads with no replies."""
    conn = None
    try:
...
def process_batch():
    """Process 2 threads to add replies to each."""
