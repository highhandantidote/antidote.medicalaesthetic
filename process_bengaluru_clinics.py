#!/usr/bin/env python3
"""
Process Bengaluru Google Places clinic data for database import.
This script cleans and transforms the scraped Bengaluru clinic data into the format needed for our clinic database.
"""
...
def process_bengaluru_clinic_data():
    """Process the Bengaluru clinic data CSV and create a cleaned version."""
    input_file = "attached_assets/dataset_crawler-google-places_2025-06-20_09-37-55-443_1750412392601.csv"
    output_file = "bengaluru_clinics.csv"
    ...
    try:
        with open(input_file, 'r', encoding='utf-8') as infile:
            ...
            for index, row in enumerate(reader, 1):
                ...
                # Clean city name - remove "Bengaluru" duplicates
                ...
                clinic_data = {
                    ...
                    'city': city,
                    'state': 'Karnataka',  # All Bengaluru clinics are in Karnataka
                    'country': 'India',
                    'pincode': pincode,
                ...
                # Progress indicator
                if index % 100 == 0:
                    print(f"Processed {index} Bengaluru clinics...")
        ...
        print(f"\n✅ Successfully processed {len(processed_clinics)} Bengaluru clinics")
        print(f"📁 Output file: {output_file}")
        print(f"📊 Data ready for import into clinic database")
        
        # Show sample of processed data
        if processed_clinics:
            print(f"\n📋 Sample Bengaluru clinic data:")
