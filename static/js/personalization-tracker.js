...
class PersonalizationTracker {
    ...
    sendInteractions() {
        ...
        this.interactions.forEach(interaction => {
            ...
            // Use fetchWithCSRF to send to the CSRF-exempt endpoint
            if (window.fetchWithCSRF) {
                window.fetchWithCSRF('/api/track-interaction', {
                    method: 'POST',
                ...
                // Fallback for older pages - use regular fetch since this endpoint is CSRF-exempt
