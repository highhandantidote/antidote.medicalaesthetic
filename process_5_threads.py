"""
Process 5 threads at a time to add replies.
This script handles a smaller batch to complete quickly.
"""
import os
import logging
import psycopg2
...
# Constants
BATCH_SIZE = 5  # Smaller batch size to complete quickly
MIN_REPLIES = 2
MAX_REPLIES = 3
...
def process_batch():
    """Process up to 5 threads to add replies to each."""
